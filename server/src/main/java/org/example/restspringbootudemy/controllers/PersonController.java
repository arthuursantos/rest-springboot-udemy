...
public class PersonController {
    ...
    @GetMapping(value = "/findByName/{firstName}",
            produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YAML})
    @Operation(summary = "Finds Person by firstName", description = "Finds Person by firstName", tags = {"Person"},
            responses = {
                    @ApiResponse(
                            description = "Success",
                            responseCode = "200",
    ...
    public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findByName(
